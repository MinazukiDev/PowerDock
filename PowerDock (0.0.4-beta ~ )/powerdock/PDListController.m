...
- (void)devtweak {
            	UIApplication *app = [UIApplication sharedApplication];
	if ([app canOpenURL:[NSURL URLWithString:@"twitter://user?screen_name=DevTweak"]]) {
		[app openURL:[NSURL URLWithString:@"twitter://user?screen_name=DevTweak"]];
	} else if ([app canOpenURL:[NSURL URLWithString:@"tweetbot:///user_profile/DevTweak"]]) {
		[app openURL:[NSURL URLWithString:@"tweetbot:///user_profile/DevTweak"]];		
	} else {
		[app openURL:[NSURL URLWithString:@"https://mobile.twitter.com/DevTweak"]];
        }
}

- (void)linux {
            	UIApplication *app = [UIApplication sharedApplication];
	if ([app canOpenURL:[NSURL URLWithString:@"twitter://user?screen_name=linux_n1"]]) {
		[app openURL:[NSURL URLWithString:@"twitter://user?screen_name=linux_n1"]];
	} else if ([app canOpenURL:[NSURL URLWithString:@"tweetbot:///user_profile/linux_n1"]]) {
		[app openURL:[NSURL URLWithString:@"tweetbot:///user_profile/linux_n1"]];		
	} else {
		[app openURL:[NSURL URLWithString:@"https://mobile.twitter.com/linux_n1"]];
        }
}
